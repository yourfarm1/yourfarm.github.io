...
<section class="icon  pl-5 mt-3">
 ...
 <div class="text-center">
   <button class="btn btn-outline-success">Get Your Box Now !</button>
 </div>
  ...
  <div class="container">
   <div class="row">
     ...
     <div class="col-sm-12 text-center">
       <button class="btn btn-outline-cyan">Book Your FARM Now</button>
...
<div class="mid-row1 row">
<div class="col-md-6">
  <p align="justify"><h3>1. Organic Food Is Better for Our Health</h3><br>
